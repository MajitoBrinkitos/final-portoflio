        ...
        <>
            <div className="pt-[100px] sm:pt-[100px] bg-[#eeeeee] text-[#222831] w-full min-h-screen px-4 sm:px-6 lg:px-20 py-12 xl:h-full xl:py-32 flex flex-col md:flex-row items-center justify-center gap-12">
                <div className="grid grid-cols-2 gap-2 h-96">
                    <div className="flex flex-col justify-center">
                        <span className="text-[#ff5722] text-[24px] mb-5">January 1st - 2024</span>
                        <h2 className="text-[#222831] text-5xl mb-5">From Then to There and Now</h2>
            ...
            <hr className="w-full" />
             ...
             <div className="pt-[100px] sm:pt-[100px] bg-[#eeeeee] text-[#222831] w-full min-h-screen px-4 sm:px-6 lg:px-20 py-12 xl:h-full xl:py-32 flex flex-col md:flex-row items-center justify-center gap-12">
                <div className="grid grid-cols-2 gap-2">
                    <div className="flex flex-col justify-center">
                        <span className="text-[#ff5722] text-[24px] mb-5">July 16 - 2024</span>
                        <h2 className="text-[#222831] text-5xl mb-5">Where do I start?</h2>
            ...
            <hr className="w-full" />
             ...
             <div className="pt-[100px] sm:pt-[100px] bg-[#eeeeee] text-[#222831] w-full min-h-screen px-4 sm:px-6 lg:px-20 py-12 xl:h-full xl:py-32 flex flex-col md:flex-row items-center justify-center gap-12">
                <div className="grid grid-cols-2 gap-2">
                    <div className="flex flex-col justify-center">
                        <span className="text-[#ff5722] text-[24px] mb-5">October 5 - 2025</span>
                        <h2 className="text-[#222831] text-5xl mb-5">Never fall for a bootcamp</h2>
